...
<div style="background:#F4F1E8;border-left:3px solid #B07D1E;padding:24px 28px;margin-top:16px">
  ...
  <p style="font-size:16px;color:#5C5A52">The 7-day plan in this report is designed to generate the first wave of audience language — questions, objections, and vocabulary — from real ${city} buyers. Run the audit again in 30 days.</p>
</div>

${prose ? `<p style="font-size:17px;color:#5C5A52;margin-top:16px">${e(prose)}</p>` : ""}`;
}
